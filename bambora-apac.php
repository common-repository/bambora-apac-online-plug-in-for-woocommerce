...
class Bambora_Apac extends WC_Payment_Gateway_CC {
    ...
    function __construct() {
       ...
       // var_dump($this->environment_url,$this->action_url); die;
        ...
        echo "<script>SITE_URL = '" . get_site_url() . "'</script>";
    ...
    public function check_callback_usr() {
        ...
        if($customer_order->status == 'processing'){
            ...
            echo "<script type='text/javascript'>
                ...
                setTimeout(function() {
                  window.parent.location = '" . get_site_url() . "/checkout/order-received/".$order_id."/?key=".$order_key[0]."';
                }, 3000);                
                    </script>";
	       ...
	       <div  style="margin:auto;width: 50px;">
            ...
            $error_message = $this->queryTransaction($_POST['SST'], $_POST['SessionId']);
            echo "Payment failed: " . $error_message;   
            echo "<script type='text/javascript'>

                setTimeout(function() {
                  window.parent.location = '" . get_site_url() . "/checkout/';
                }, 3000);                
                    </script>";
            echo  '<link rel="stylesheet" type="text/css" href="'.get_site_url() . '/wp-content/plugins/bambora-apac-online/assets/css/ui.bambora.1.2.0.css">';
            echo  '
    ...
    protected function queryTransaction($sst, $sessionid)
    {
        ...
        $postfield = 'UserName='.$this->UserName.'&';
        $postfield .= 'Password='.$this->Password.'&';
        $postfield .= 'SST='.$sst.'&';
        ...
        curl_setopt($ch, CURLOPT_URL, $this->IntegratedUrl);
